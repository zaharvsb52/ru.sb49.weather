...
#if NETSTANDARD2_0 //GLEB        

        public static Attribute[] GetCustomAttributes(this Type type, Type other, bool inherit) =>
            type.GetTypeInfo().GetCustomAttributes(other, inherit).Cast<Attribute>().ToArray();

#else

        public static Attribute[] GetCustomAttributes(this Type type, Type other, bool inherit) =>
            type.GetTypeInfo().GetCustomAttributes(other, inherit).ToArray();
