...
namespace log4net.Util
{
	...
	public abstract class TextWriterAdapter : TextWriter
	{
		...
		{
			get { return _mWriter.FormatProvider; }
		}
		...
		{
			get { return _mWriter.NewLine; }
			set { _mWriter.NewLine = value; }
		}
...
//GLEB #if NETSTANDARD1_3
		...
		{
			_mWriter.Write(buffer, index, count);
		}
